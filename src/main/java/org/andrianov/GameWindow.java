...
public class GameWindow extends JFrame {
    ...
    public GameWindow(){
        ...
        rootPane.setBackground(new Color(62,32,92));
        gamePanel.setLayout(null);
        ...
        scorePanel.setMinimumSize(new Dimension(700,200));
        scorePanel.setPreferredSize(new Dimension(700,200));
        scorePanel.setMaximumSize(new Dimension(700,200));
